  ...
  */
  ...
  export interface NoterDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `noter_id`
     * const noterWithNoter_idOnly = await prisma.noter.findMany({ select: { noter_id: true } })
     * 
    **/
  ...
  export type NoterScalarWhereWithAggregatesInput = {
    ...
    noter_id?: IntWithAggregatesFilter | number
  ...
  export type NoterUncheckedUpdateInput = {
    noter_id?: IntFieldUpdateOperationsInput | number
